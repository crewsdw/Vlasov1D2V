...
# Purpose:
# Check out the kernel function for imaginary frequency
...
L = 100
k = 2.0 * np.pi / L
print('Wavenumber is ' + str(k))
v = np.linspace(1.0e-6, 7.5, num=75)
phi = np.linspace(0, 2.0*np.pi, num=75)
space = np.linspace(0, L, num=75)
b = - k * v
om_p = 4.912e-1j # 1.414 # 0.3110j # 1.0e-5 # 2.05 # 3.1 # 1.414 # 1.2 + 0.2j # 0.9 # 1.414 # 1.2 + 0.2j # 0.0 + 0.3110j
om_n = -4.912e-1j # -1.414 # -0.3110j # -1.0e-5 # -2.05 # -3.1 # -1.414
